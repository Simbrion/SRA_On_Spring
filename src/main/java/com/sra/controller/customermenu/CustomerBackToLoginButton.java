...
public class CustomerBackToLoginButton implements LoggedInMenuButton {
    ...
    @Autowired    public CustomerBackToLoginButton(CustomerBackToLoginCommand customerBackToLoginCommand) {
        this.customerBackToLoginCommand = customerBackToLoginCommand;
    }
