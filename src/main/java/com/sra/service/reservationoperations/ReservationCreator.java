...
public class ReservationCreator {
    ...
    @Autowired
    public ReservationCreator (RepositoriesSet repositoriesSet,
                               ReservationSpaceSelector reservationSpaceSelector,
                               ReservationDateSelector reservationDateSelector,
                               ReservationStartTimeSelector reservationStartTimeSelector,
                               ReservationEndTimeSelector reservationEndTimeSelector) {
        this.repositoriesSet = repositoriesSet;
        this.reservationSpaceSelector = reservationSpaceSelector;
        this.reservationDateSelector = reservationDateSelector;
        this.reservationStartTimeSelector = reservationStartTimeSelector;
        this.reservationEndTimeSelector = reservationEndTimeSelector;
    }
